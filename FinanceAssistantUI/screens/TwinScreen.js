    ...
    return (
      <View style={styles.twinRow}>
        <View style={styles.twinHeader}>
            <Text style={[styles.twinLabel, isUser && {color: colors.primary, fontWeight: 'bold'}]}>
                {label}
            </Text>
            <Text style={[styles.twinAmount, isUser && {color: colors.primary, fontWeight: 'bold'}]}>
        ...
        <ProgressBar 
            ...
            showPercentage={true}
        />
        <Text style={styles.twinDesc}>{scenario.description}</Text>
      </View>
    );
  };
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        >
            ...
            <View style={[styles.card, {backgroundColor: colors.surface}]}>
                ...
                <Text style={styles.xpHint}>Beat twins at the end of the month to gain XP!</Text>
            </View>
            ...
            <View style={[styles.card, {backgroundColor: colors.surface}]}>
                ...
                <View style={styles.badgesContainer}>
                    {gamification_profile.badges.length === 0 ? (
                        <Text style={styles.noBadges}>No badges earned yet. Defeat the Hard Twin to earn one!</Text>
                    ) : (
